...
import KellerkindImage3 from '../img/articles/kellerkind/back_to_the_woods3.jpg'
      ...
      <div>
          ...
          <ul>
            <li>
              <p>
                ...
                design of their work. E.g.: handmade screens for visuals made
                out of cloth are better than LED screens. Custom built DIY food
                stands are better than ready-made pavilions from the store. The
                visual quality of the event is just as important as the acoustic
                quality.
              </p>
            </li>
            <li>
              <p>
                ...
                bought a ticket beforehand. Also at the bar, every minute of
            ...
            <li>
              <p>
                ...
                <br />Putting emphasis on visual design does not mean forgetting
                why people are initally attending a music event. So we always
                tried to pay attention to have the best possible sound quality
                on all stages.
              </p>
            </li>
          </ul>
        ...
        <ContentWrapper>
          ...
          <p>
            ...
            keep surprising our guests with ever more immersive and holistic
            experiences.
          </p>
        </ContentWrapper>
        <TwoImage
          ...
          maxHeight={'450px'}
        />
        {/*        <FullSizeImage src={KellerkindImage3} />*/}
        <Footer />
      </div>
    )
  },
